...
def has_won(board, player):
    ...
    if board[0][0] == player and board[0][2] == player and board[0][4] == player:
        is_win == True
    if board[1][0] == player and board[1][2] == player and board[1][4] == player:
        is_win == True
    if board[2][0] == player and board[2][2] == player and board[2][4] == player:
        is_win == True
    if board[0][0] == player and board[1][0] == player and board[2][0] == player:
        is_win == True
    if board[0][2] == player and board[1][2] == player and board[2][2] == player:
        is_win == True
    if board[0][4] == player and board[1][4] == player and board[2][4] == player:
        is_win == True  
    if board[0][0] == player and board[1][2] == player and board[2][4] == player:
        is_win == True    
    if board[2][0] == player and board[1][2] == player and board[0][4] == player:
        is_win == True
